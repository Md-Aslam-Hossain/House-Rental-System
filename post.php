...
<html> 
<head>
	<title> Post and Sale/Rent </title>
...
<div id="allform">
<form action="_includes/postpros.php" method="post" enctype="multipart/form-data">
<table width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr style="height:60px;">
    ...
    <td width="500" class="textwithbg"> <?php echo $sel_subject['title']; ?><?php echo $sel_page['sub_title']; ?><br/><a href="category.php">Change your category </a></td>
  </tr>
  ...
  <tr>
   ...
   <td style="font-size:12px; font-family:'Times New Roman';" > <p> Write price according to Bangladeshi currency <input name="price" type="number" size="20" maxlength="50"  id="currency" placeholder="example: 500.00"> .OO Tk</td>
  </tr>
</table>
<div id="sellerinfo">
