...
$query="Select * from userad where address like '%$search%' ";
$userad=mysql_query($query);
$query="Select * from freead where address like '%search%'";
...
<table width="100%" cellspacing="4" cellpadding="4" id="table">
  ...
  <tr>
    <td  class="adbg" colspan="2">Address:<br/><span style="color:#666;"><?php echo $rec['address']; ?></span><br/></td>
...
<?php $k++; }
//$query="Select * from freead where cat_id='$search' ";$query="Select * from freead where cat_id='$search' ";$query="Select * from freead where cat_id='$search' ";$query="Select * from freead where cat_id='$search' ";$query="Select * from freead where cat_id='$search' ";$query="Select * from freead where cat_id='$search' ";$query="Select * from freead where cat_id='$search' ";$query="Select * from freead where cat_id='$search' ";$query="Select * from freead where cat_id='$search' ";$query="Select * from freead where cat_id='$search' ";}
//else {
