...
<table width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
   ...
   <td style="font-size:12px; font-family:'Times New Roman';" > <p> Write price according to Bangladeshi currency <input name="price" type="number" size="20" maxlength="50"  id="currency" placeholder="example: 50.00"> .OO Tk</td>
  </tr>
</table>
<div id="sellerinfo">
